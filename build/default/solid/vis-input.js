...
import { VisinputAgent } from './agents/VisinputAgent.js'; //import  '/node_modules/solid-file-client/solid-file-client.js';
...
class VisInput extends LitElement {
  ...
  constructor() {
    super(); //  this._input = this.shadowRoot.getElementById('input');
  ...
  firstUpdated() {
    ...
    this.agentVisinput.send('agentApp', {
      type: 'dispo',
      name: 'agentInput'
    });
  ...
  _inputChanged() {
    if (this.shadowRoot.getElementById('input') != null) {
      // revoir l'initialisation de cet element
      ...
      if (retour.message != undefined) {
        console.log(retour);
        this.agentVisinput.send(this.destinataire, {
          type: "catchTriplet",
          triplet: retour.message
        });
      }
    }
  }
    ...
    switch (firstChar) {
      ...
      default:
        ...
        if (isTriplet) {
          ...
          retour.message = messageCut; //        this.agentInput.send('agentSparqlUpdate', {type: "catchTriplet", triplet:messageCut});
        }
  ...
  catchCommande(commande) {
    ...
    switch (commande) {
      ...
      case "/aide":
        ...
        console.log("help"); //  this.$.dialogs.$.helpPopUp.toggle();
      ...
      case "/n":
        console.log("new graph"); //  this.newGraph(this.network, this);
      ...
      case "/b":
        console.log("connection a la base levelgraph"); //  this.connectBase(this.network,this);
