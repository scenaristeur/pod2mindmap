...
import "../node_modules/@polymer/paper-input/paper-input.js"; //import  '/node_modules/solid-file-client/solid-file-client.js';
...
class SolidFilemanager extends LitElement {
  ...
  static get properties() {
    return {
      ...
      //  context: {type: Object},
      //  webId: Object,
      public: String //  current: {type: Object},
      //  thing: {type: Object}
  ...
  connectedCallback() {
    super.connectedCallback(); //  var app = this;
    //  console.log(solid)
    //  console.log($rdf)
    //  app.thing={}
